...
class ContentFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    const CONTENT = [
        ...
        2 => [
            ...
            'text' => '
Le texte qui suit est le résultat d\'une écriture collaborative de plusieurs membres. Il a été imaginé dans un jeu de cadavre exquis réalisés a travers notre site internet.
