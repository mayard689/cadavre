...
class StatTagManager
{
    ...
    private function getBrowser()
    {
        ...
        $browser_array = array( '/mobile/i'    => 'Handheld Browser',
            ...
            '/Google/i' => 'bot Google',
            '/msnbot/i' => 'bot MNS',
            '/Rambler/i' => 'bot Rambler',
            '/Yahoo/i' => 'bot Yahoo',
            '/AbachoBOT/i' => 'bot AbachoBOT',
            '/accoona/i' => 'bot Accoona',
            '/AcoiRobot/i' => 'bot AcoiRobot',
            '/ASPSeek/i' => 'bot ASPSeek',
            '/CrocCrawler/i' => 'bot CrocCrawler',
            '/Dumbot/i' => 'bot Dumbot',
            '/FAST-WebCrawler/i' => 'bot FAST-WebCrawler',
            '/GeonaBot/i' => 'bot GeonaBot',
            '/Gigabot/i' => 'bot Gigabot',
            '/Lycos spider/i' => 'bot Lycos',
            '/MSRBOT/i' => 'bot MSRBOT',
            '/Scooter robot/i' => 'bot Altavista',
            '/AltaVista robot/i' => 'bot Altavista',
            '/IDBot/i' => 'bot ID-Search Bot',
            '/eStyle/i' => 'bot eStyle',
            '/Scrubby/i' => 'bot Scrubby',
            '/facebookexternalhit/i' => 'bot Facebook',
        );
